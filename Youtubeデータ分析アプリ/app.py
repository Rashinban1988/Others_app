...
DEVELOPER_KEY = "AIzaSyCFU069GGDYgB4ttgwYyPclilE_T6zqCD4"
YOUTUBE_API_SERVICE_NAME = "youtube"
YOUTUBE_API_VERSION = "v3"

youtube = build(YOUTUBE_API_SERVICE_NAME, YOUTUBE_API_VERSION,developerKey=DEVELOPER_KEY)

def video_search(youtube, q='100均　おたま', max_results=50):
...
threshold = st.sidebar.slider('登録者数のしきい値', 100, 10000, 5000)
...
url = f'https://www.youtu.be/{video_id}'
